 ...
 */
final class Version20241216153528 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE demande_selection (id INT AUTO_INCREMENT NOT NULL, chambre_id INT NOT NULL, foyer_id INT NOT NULL, date_demande DATETIME NOT NULL, statut VARCHAR(255) NOT NULL, INDEX IDX_E389F6029B177F54 (chambre_id), INDEX IDX_E389F6022B919A58 (foyer_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
